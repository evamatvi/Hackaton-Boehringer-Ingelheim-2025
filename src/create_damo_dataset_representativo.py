...
def generate_new_patients():
    ...
    data = [
        ...
        # 3. EL CASO "CARMEN" (Paciente que podría ocultar la enfermedad - Riesgo Oculto)
        # Riñón "aparentemente" bien (Creatina 1.0), pero con Anemia e Hipertension. 
        # El modelo debería dudar y marcar Riesgo Medio
        {
            'id': 'PAC-003 (Carmen - Oculto)',
            'age': 50, 'bp': 140, 'sg': 1.015, 'al': 0, 'su': 0, 
            'rbc': 'normal', 'pc': 'normal', 'pcc': 'notpresent', 'ba': 'notpresent',
            'bgr': 110, 'bu': 40, 'sc': 1.0, 'sod': 138, 'pot': 4.1, 'hemo': 11.5, 
            'pcv': 36, 'wc': 8000, 'rc': 4.0,
    ...
    print("   -> Sube este archivo a la Web para hacer la Demo demostrativa.")
